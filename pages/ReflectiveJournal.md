...
The blockout was then exported to zBrush to sculpt wear onto the metal and grain onto the wood. Designing the asset with panelling would have allowed me to overlap UVs to save on creation time, however I instead used it to do batches of practice and reflection. This facilitated experimentation and direct comparison, and led to rapid improvements with the final panel being of a significantly higher quality than the first one. This was partly due to selection of a better brush and preview material, and partly from being more familiar with the software, both through practice and through arranging a software 'masterclass' from an assistant lecturer experienced with the software.
