...
After these initial iterations I moved into zBrush to do a more detailed blockout. I switched to zBrush as I wanted to try zModeller, partly because it has live booleans and I really enjoy the dynamic workflow they enable.

<h3>Substance Designer</h3>
I knew that this project would primarily use a tileable stone brick texture, so begun looking into Substance Designer to create this. I used <a href="https://www.youtube.com/watch?v=VMfVQs5G-gE">this tutorial (3dEx, 2018)</a> as a starting point as it answered key questions about how to make a texture tileable and general navigation. I broke away within the first few minutes to develop it independently as I found the software very intuitive and my programming background helped significantly, as the node based system is just <a href="https://www.tabnine.com/blog/what-is-visual-scripting/">visual scripting (Tabnine Team, 2021),</a> which I'm familiar with. 
...
Early importation into engine allowed me to set up the engine material early and refine it, for example I set it up so it tiled, then realised it tiled in the objects local space, requiring custom scaling per asset. I then implemented world scaling manually, before discovering there was an existing node for this. This has allowed me to have a single primary material that controls the brick scale for all assets, which I can then instance if an asset has its own normal or AO map.
...
Word count: 1,745 not including references, image captions, or this sentence. 
